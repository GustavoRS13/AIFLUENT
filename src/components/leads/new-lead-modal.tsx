...
const courseOptions = [
  ...
  "Ingles - Kids",
  "Espanhol - Business",
  "Espanhol - Conversacao",
  "Espanhol - Preparatorio",
];
...
export function NewLeadModal({
  ...
  const validate = (): boolean => {
    ...
    if (form.tags.length === 0) e.tags = "Selecione ao menos 1 tag";
    setErrors(e);
    if (e.firstName || e.email) setStep(0);
    else if (e.tags) setStep(3);
          ...
          {success && (
            ...
            >
              ...
              <p className="text-sm text-gray-500 mt-1">
                {form.firstName} foi adicionado com sucesso
              </p>
            </motion.div>
          )}
        </AnimatePresence>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:border-indigo-500/50 focus:outline-none transition-colors"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={cn(
                        ...
                        errors.email ? "border-rose-500/50" : "border-gray-200",
                      )}
                    />
                  </div>
                  {errors.email && (
              ...
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {(
                      Object.entries(temperatureConfig) as [
                        LeadTemperature,
                        typeof temperatureConfig.cold,
                      ][]
                    ).map(([key, cfg]) => (
                      <button
                        key={key}
                ...
                <div className="bg-gradient-to-br from-indigo-500/10 to-blue-500/10 border border-indigo-500/20 rounded-xl p-4">
                  ...
                  <p className="text-[10px] text-gray-500 mt-1">
                    {aiScore >= 70
                      ...
                      : aiScore >= 40
                        ? "Probabilidade moderada - investir em follow-up"
                        : "Preencha mais dados para melhorar a previsao"}
                  </p>
                </div>
              </motion.div>
            )}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-3">
                    {form.tags.map((tag) => (
                      <span
                        key={tag}
                        className="flex items-center gap-1 px-2.5 py-1 bg-indigo-500/20 text-indigo-400 text-xs font-medium rounded-lg border border-indigo-500/30"
                      >
                        {tag}
                        <button
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      { label: "Telefone", value: form.phone || "-" },
                      {
                        label: "Origem",
                        value:
                          sourceOptions.find((s) => s.value === form.source)
                            ?.label || "-",
                      },
                      {
                        label: "Temperatura",
                        value: temperatureConfig[form.temperature].label,
                      },
                      ...
                      <div key={item.label} className="flex justify-between">
                        ...
                        <span className="text-[10px] text-gray-700 font-medium text-right truncate ml-2">
                          {item.value}
                        </span>
                      </div>
                    ))}
        ...
        <div className="flex items-center justify-between px-6 py-4 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex items-center gap-2">
            ...
            {step < steps.length - 1 ? (
              <button
                onClick={() => setStep(step + 1)}
                className="flex items-center gap-1.5 px-5 py-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-xl transition-colors"
              >
              ...
              <button
                ...
                disabled={loading}
                className="flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white text-sm font-medium rounded-xl transition-all disabled:opacity-50"
              >
                {loading ? (
